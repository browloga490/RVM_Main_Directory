...
frame = Graph_Frame(r'/usr/local/RVMD/GUI/Ch0_Graphs/')

#graph_X = Graph(ID, *kwargs)

graph_1 = Graph('Ch0_AVG',has_cbar=True,has_gradient=True)
graph_2 = Graph('Ch0_AVG',has_cbar=True,has_gradient=True)
graph_3 = Graph('Ch0_AVG',has_cbar=True,has_gradient=True)
graph_4 = Graph('Ch0_AVG',has_cbar=True,has_gradient=True)

graph_5 = Graph('Ch0_LOOSE',fill_color='lightsteelblue')
graph_6 = Graph('Ch0_LOOSE',fill_color='lightsteelblue')
graph_7 = Graph('Ch0_LOOSE',fill_color='lightsteelblue')
graph_8 = Graph('Ch0_LOOSE',fill_color='lightsteelblue')

graph_9 = Graph('Ch0_MISA',fill_color='lightsteelblue')
graph_10 = Graph('Ch0_MISA',fill_color='lightsteelblue')
graph_11 = Graph('Ch0_MISA',fill_color='lightsteelblue')
graph_12 = Graph('Ch0_MISA',fill_color='lightsteelblue')

graph_13 = Graph('Ch0_BEAR',fill_color='lightsteelblue')
graph_14 = Graph('Ch0_BEAR',fill_color='lightsteelblue')
graph_15 = Graph('Ch0_BEAR',fill_color='lightsteelblue')
graph_16 = Graph('Ch0_BEAR',fill_color='lightsteelblue')

graph_17 = Graph('Ch0_GEARS',fill_color='lightsteelblue')
graph_18 = Graph('Ch0_GEARS',fill_color='lightsteelblue')
graph_19 = Graph('Ch0_GEARS',fill_color='lightsteelblue')
graph_20 = Graph('Ch0_GEARS',fill_color='lightsteelblue')

graph_21 = Graph('Ch0_OTHER',fill_color='lightsteelblue')
graph_22 = Graph('Ch0_OTHER',fill_color='lightsteelblue')
graph_23 = Graph('Ch0_OTHER',fill_color='lightsteelblue')
graph_24 = Graph('Ch0_OTHER',fill_color='lightsteelblue')

graph_1.read_file('master_mem.txt',0,7,7)
graph_2.read_file('master_mem.txt',0,7,31)
graph_3.read_file('master_mem.txt',0,7,93)
graph_4.read_file('master_mem.txt',0,7,186)
