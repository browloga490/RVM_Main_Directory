...
frame = Graph_Frame(r'/usr/local/RVMD/GUI/Ch2_Graphs/')

#graph_X = Graph(ID, *kwargs)

graph_1 = Graph('Ch2_AVG',has_cbar=True,has_gradient=True)
graph_2 = Graph('Ch2_AVG',has_cbar=True,has_gradient=True)
graph_3 = Graph('Ch2_AVG',has_cbar=True,has_gradient=True)
graph_4 = Graph('Ch2_AVG',has_cbar=True,has_gradient=True)

graph_5 = Graph('Ch2_LOOSE',fill_color='lightsteelblue')
graph_6 = Graph('Ch2_LOOSE',fill_color='lightsteelblue')
graph_7 = Graph('Ch2_LOOSE',fill_color='lightsteelblue')
graph_8 = Graph('Ch2_LOOSE',fill_color='lightsteelblue')

graph_9 = Graph('Ch2_MISA',fill_color='honeydew')
graph_10 = Graph('Ch2_MISA',fill_color='honeydew')
graph_11 = Graph('Ch2_MISA',fill_color='honeydew')
graph_12 = Graph('Ch2_MISA',fill_color='honeydew')

graph_13 = Graph('Ch2_BEAR',fill_color='limegreen')
graph_14 = Graph('Ch2_BEAR',fill_color='limegreen')
graph_15 = Graph('Ch2_BEAR',fill_color='limegreen')
graph_16 = Graph('Ch2_BEAR',fill_color='limegreen')

graph_17 = Graph('Ch2_GEARS',fill_color='plum')
graph_18 = Graph('Ch2_GEARS',fill_color='plum')
graph_19 = Graph('Ch2_GEARS',fill_color='plum')
graph_20 = Graph('Ch2_GEARS',fill_color='plum')

graph_21 = Graph('Ch2_OTHER',fill_color='thistle')
graph_22 = Graph('Ch2_OTHER',fill_color='thistle')
graph_23 = Graph('Ch2_OTHER',fill_color='thistle')
graph_24 = Graph('Ch2_OTHER',fill_color='thistle')
