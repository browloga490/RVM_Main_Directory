...
frame = Graph_Frame(r'/usr/local/RVMD/GUI/Ch1_Graphs/')

#graph_X = Graph(ID, *kwargs)

graph_1 = Graph('Ch1_AVG',has_cbar=True,has_gradient=True)
graph_2 = Graph('Ch1_AVG',has_cbar=True,has_gradient=True)
graph_3 = Graph('Ch1_AVG',has_cbar=True,has_gradient=True)
graph_4 = Graph('Ch1_AVG',has_cbar=True,has_gradient=True)

graph_5 = Graph('Ch1_LOOSE',fill_color='lightsteelblue')
graph_6 = Graph('Ch1_LOOSE',fill_color='lightsteelblue')
graph_7 = Graph('Ch1_LOOSE',fill_color='lightsteelblue')
graph_8 = Graph('Ch1_LOOSE',fill_color='lightsteelblue')

graph_9 = Graph('Ch1_MISA',fill_color='honeydew')
graph_10 = Graph('Ch1_MISA',fill_color='honeydew')
graph_11 = Graph('Ch1_MISA',fill_color='honeydew')
graph_12 = Graph('Ch1_MISA',fill_color='honeydew')

graph_13 = Graph('Ch1_BEAR',fill_color='limegreen')
graph_14 = Graph('Ch1_BEAR',fill_color='limegreen')
graph_15 = Graph('Ch1_BEAR',fill_color='limegreen')
graph_16 = Graph('Ch1_BEAR',fill_color='limegreen')

graph_17 = Graph('Ch1_GEARS',fill_color='plum')
graph_18 = Graph('Ch1_GEARS',fill_color='plum')
graph_19 = Graph('Ch1_GEARS',fill_color='plum')
graph_20 = Graph('Ch1_GEARS',fill_color='plum')

graph_21 = Graph('Ch1_OTHER',fill_color='thistle')
graph_22 = Graph('Ch1_OTHER',fill_color='thistle')
graph_23 = Graph('Ch1_OTHER',fill_color='thistle')
graph_24 = Graph('Ch1_OTHER',fill_color='thistle')
